 ...
 */
// Code taken from https://github.com/alejandro-du/vaadin-microservices-demo/blob/master/proxy-server/src/main/java/com/example/StickySessionRule.java
// It implements sticky sessions through cookies.
// Otherwise authentication breaks with multiple EventarzApplication instances.
// TODO: Figure out if maybe some other solution (Session store, tokens??) would work better.
@RibbonClient(name = "StickySessionRule")
